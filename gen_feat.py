...
action_1_path = "./data/sample/two_user_actions2.csv"
action_2_path = "./data/sample/two_user_actions3.csv"
action_3_path = "./data/sample/two_user_actions4.csv"
user_path = "./data/sample/two_user.csv"
...
def get_accumulate_user_feat(start_date, end_date):
    ...
    if os.path.exists(dump_path):
        ...
        # TODO 这里有bug，用户没下单，那么 action_4 将会等于0，那么如何来处理这个值
        # action 4 是下单的情况
